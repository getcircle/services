...
RUN pip install --no-deps git+https://github.com/circlehq/django-date-extensions.git@0b65a33
...
RUN pip install --no-deps git+https://c9b60542c1a793a1bcc0b1e95ce3ab3d2da148c4:x-oauth-basic@github.com/getcircle/protobuf-registry.git@0.34.10
