...
NAME = ENV['VAGRANT_DOCKER_NAME'] || 'dev'
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define NAME do |vdocker|
    vdocker.vm.hostname = NAME
...
SH
    ...
    vdocker.vm.synced_folder ".", "/home/vagrant/mnt", type: "nfs", nfs_udp: true, nfs_version: 3
